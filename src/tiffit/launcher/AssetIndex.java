...
public class AssetIndex {
	...
	public AssetDownloadable getDownloadable(TCVersion version, AssetObject object) throws MalformedURLException{
		File objectsFolder = new File(FileData.VERSION_DATA.getVersionFile("assets"), "objects");
		return new AssetDownloadable(Proxy.NO_PROXY, getUniqueObjects().get(object), object, "http://resources.download.minecraft.net/", objectsFolder);
	}
	...
	public class AssetObject {
		...
		public boolean equals(Object o) {
			...
			if (this.compressedHash != null ? !this.compressedHash.equals(that.compressedHash)
					: that.compressedHash != null) {
				return false;
			}
